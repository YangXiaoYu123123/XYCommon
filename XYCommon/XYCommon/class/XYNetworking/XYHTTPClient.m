...
static NSString *ApiDomain = @"ApiDomain";

@interface XYHTTPClient(x)
...
+ (id)defaultClient {
    ...
    dispatch_once(&initOnceHttpRequestClient, ^{
        _defaultHttpRequestClient = [[XYHTTPClient alloc] initWithBaseURL:[NSURL URLWithString:ApiDomain]];
    });
...
- (id)initWithBaseURL:(NSURL *)url {
    ...
    [self registerHTTPOperationClass:[XYHttpRequestOperation class]];
